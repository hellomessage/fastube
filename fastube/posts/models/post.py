...
class Post(models.Model):
    ...
    def get_youtube_original_url(self):
        from posts.utils.youtube import get_youtube_original_url as get_youtube_original_url_form_video_id
        return get_youtube_original_url_form_video_id(self.video_id)
    ...
    def get_youtube_embed_url(self):
        ...
        return get_youtebe_embed_url_embed_url_from_video_id(slef.video_id)
